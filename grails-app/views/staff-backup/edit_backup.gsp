...
<html>
    ...
    <body>
        ...
        <div id="edit-staff" class="content scaffold-edit" role="main">
            ...
            <g:hasErrors bean="${this.staff}">
            <ul class="errors" role="alert">
                <g:eachError bean="${this.staff}" var="error">
                <li <g:if test="${error in org.springframework.validation.FieldError}">data-field-id="${error.field}"</g:if>><g:message error="${error}"/></li>
                </g:eachError>
            </ul>
            </g:hasErrors>
            <g:form resource="${this.staff}" method="PUT">
                <g:hiddenField name="version" value="${this.staff?.version}" />
                <fieldset class="form">
                    <f:all bean="staff"/>
                </fieldset>
