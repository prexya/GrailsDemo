...
<html>
    ...
    <body>
        ...
        <div id="show-staff" class="content scaffold-show" role="main">
            ...
            <f:display bean="staff" />
            <g:form resource="${this.staff}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.staff}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
